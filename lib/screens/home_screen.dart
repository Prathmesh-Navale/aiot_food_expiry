...
import 'package:aiot_ui/screens/dashboard/productivity_screen.dart'; // Ensure this file exists
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _initializeScreens() {
    ...
    _screens = [
      ...
      SalesDashboardScreen(apiService: widget.apiService, onNavigate: _onNavigate), // 1
      ...
      // ✅ FIXED: Passed apiService to ForecastScreen and removed 'const'
      ForecastScreen(apiService: widget.apiService), // 5
